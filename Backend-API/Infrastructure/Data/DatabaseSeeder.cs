...
new { NameEn = "Taxation", NameAr = "???????" },
  ...
  private async Task SeedQuestionSubjectsAsync(List<string> messages)
  {
    ...
    var subjectsToSeed = new[]
    {
      ...
      new { NameEn = "Science", NameAr = "العلوم" },
      new { NameEn = "Computer Science", NameAr = "علوم الحاسوب" },
      new { NameEn = "English Language", NameAr = "اللغة الإنجليزية" },
      new { NameEn = "Arabic Language", NameAr = "اللغة العربية" },
 ...
 new { Id = 4, NameEn = "Subjective", NameAr = "سؤال مقالي" }
        };
