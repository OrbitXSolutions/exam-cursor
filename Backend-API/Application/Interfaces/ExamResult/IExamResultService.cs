...
public interface IExamResultService
{
  ...
  /// </summary>
  Task<ApiResponse<CandidateResultListResponseDto>> GetCandidateResultListAsync(int? examId, int pageNumber, int pageSize, bool excludeTerminated = true, bool onlyTerminated = false, string? statusFilter = null, string? search = null, string? resultStatus = null);
