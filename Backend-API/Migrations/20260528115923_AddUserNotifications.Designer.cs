...
namespace Smart_Core.Migrations
{
    ...
    [Migration("20260528115923_AddUserNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Assessment.Exam", b =>
                {
                    ...
                    b.Property<int>("MaxViolationWarnings")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(10);
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Assessment.WalkInRegistrationAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CandidateId", "ExamId", "FieldId")
                        .IsUnique()
                        .HasDatabaseName("IX_WalkInRegistrationAnswers_Candidate_Exam_Field");

                    b.ToTable("WalkInRegistrationAnswers", (string)null);
                });

            modelBuilder.Entity("Smart_Core.Domain.Entities.Assessment.WalkInRegistrationField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WalkInRegistrationFields", (string)null);
                });

            modelBuilder.Entity("Smart_Core.Domain.Entities.Attempt.AdminAttemptOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Attempt.Attempt", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("DisconnectDetectedAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<DateTimeOffset?>("ForceSubmittedAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<string>("ForceSubmittedBy")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.ExamAssignment.ExamAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTimeOffset>("ScheduleFrom")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset>("ScheduleTo")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Logs.SystemLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("Category")
                        .HasDatabaseName("IX_SystemLogs_Category");
                    ...
                    b.HasIndex("Category", "Timestamp")
                        .HasDatabaseName("IX_SystemLogs_Category_Timestamp");

                    b.HasIndex("Category", "UserId")
                        .HasDatabaseName("IX_SystemLogs_Category_UserId");
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Lookups.QuestionTopic", b =>
                {
                    ...
                    b.HasIndex("SubjectId", "NameAr")
                        .IsUnique()
                        .HasDatabaseName("IX_QuestionTopics_SubjectId_NameAr");

                    b.HasIndex("SubjectId", "NameEn")
                        .IsUnique()
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Notification.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("RelatedAttemptId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Proctor.ExamProctor", b =>
                {
                    ...
                    b.HasIndex("ExamId", "ProctorId")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("ExamProctors", (string)null);
                });
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Proctor.IdentityVerification", b =>
                {
                    ...
                    b.Property<bool>("IdDocumentUploaded")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Proctor.ProctorSession", b =>
                {
                    ...
                    b.Property<int>("CountableViolationCount")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsTerminatedByProctor")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("PendingWarningMessage")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.QuestionBank.Question", b =>
                {
                    ...
                    b.Property<bool>("IsCalculatorAllowed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.SystemSettings", b =>
                {
                    ...
                    b.Property<bool>("EnableSmartMonitoring")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Assessment.ExamSection", b =>
                {
                    ...
                    b.HasOne("Smart_Core.Domain.Entities.Lookups.QuestionSubject", "QuestionSubject")
                        .WithMany()
                        .HasForeignKey("QuestionSubjectId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Smart_Core.Domain.Entities.Lookups.QuestionTopic", "QuestionTopic")
                        .WithMany()
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Assessment.WalkInRegistrationAnswer", b =>
                {
                    ...
                    b.HasOne("Smart_Core.Domain.Entities.Assessment.WalkInRegistrationField", "Field")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Attempt.AdminAttemptOverride", b =>
                {
                    ...
                    b.HasOne("Smart_Core.Domain.Entities.Attempt.Attempt", "UsedAttempt")
                        .WithMany()
                        .HasForeignKey("UsedAttemptId");

                    b.Navigation("Candidate");

                    b.Navigation("Exam");

                    b.Navigation("UsedAttempt");
                });
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Lookups.QuestionTopic", b =>
                {
                    b.HasOne("Smart_Core.Domain.Entities.Lookups.QuestionSubject", "Subject")
                        .WithMany("Topics")
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Notification.UserNotification", b =>
                {
                    ...
                    b.HasOne("Smart_Core.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Proctor.ExamProctor", b =>
                {
                    ...
                    b.HasOne("Smart_Core.Domain.Entities.ApplicationUser", "Proctor")
                        .WithMany()
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.Proctor.IdentityVerification", b =>
                {
                    b.HasOne("Smart_Core.Domain.Entities.ApplicationUser", "AssignedProctor")
                        .WithMany()
                        .HasForeignKey("AssignedProctorId");
            ...
            modelBuilder.Entity("Smart_Core.Domain.Entities.QuestionBank.Question", b =>
                {
                    ...
                    b.HasOne("Smart_Core.Domain.Entities.Lookups.QuestionTopic", "Topic")
                        .WithMany()
