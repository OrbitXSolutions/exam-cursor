...
export const resultsTutorial: TutorialModule = {
  ...
  descriptionEn:
    "Learn how to view candidate results, publish scores, send email notifications, review exam answers, manage terminated attempts, and generate AI proctor reports.",
  descriptionAr:
    "تعلّم كيفية عرض نتائج المرشحين، نشر الدرجات، إرسال إشعارات البريد، مراجعة إجابات الاختبار، إدارة المحاولات المنتهية، وإنشاء تقارير مراقب AI.",
  iconName: "ClipboardList",
...
export const candidatePortalTutorial: TutorialModule = {
  ...
  sections: [
    ...
    // ── Section 6b: Walk-in Registration ──────────────────
    {
      ...
      steps: [
          ...
          fields: [
            {
              ...
              nameAr: "الاسم الكامل",
              required: true,
              descriptionEn: "Your full name as it will appear on results",
              descriptionAr: "اسمك الكامل كما سيظهر في النتائج",
            },
            {
        ...
        },
        {
          ...
          noteEn:
            "Walk-in accounts are real candidate accounts in the system. Your results and attempt history are stored just like any other candidate.",
          noteAr:
            "حسابات التسجيل المفتوح هي حسابات مرشحين حقيقية في النظام. نتائجك وسجل محاولاتك محفوظة تماماً مثل أي مرشح آخر.",
        },
      ],
      examples: [
        {
    ...
    // ── Section 7: Submit & Results ──────────────────────
    {
      ...
      descriptionEn:
        "How to submit an exam, what happens after submission, auto-submit scenarios, and how to view results.",
      descriptionAr:
        "كيفية تقديم الاختبار، ماذا يحدث بعد التقديم، سيناريوهات التقديم التلقائي، وكيفية عرض النتائج.",
      steps: [
        {
          id: "submit-manual",
        ...
        {
          id: "results-page",
          titleEn: "Results Page",
          titleAr: "صفحة النتائج",
          descriptionEn:
