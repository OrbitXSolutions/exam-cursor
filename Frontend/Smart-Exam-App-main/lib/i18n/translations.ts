...
export const translations = {
  en: {
    ...
    nav: {
      ...
      terminatedAttempts: "Terminated Attempts",
    ...
    instructions: {
      ...
      screenSharingDesc:
        "You will be asked to share your screen during the exam",
      screenMonitoring: "Screen Monitoring",
      testScreenShare: "Test",
      required: "Required",
    ...
    exam: {
      ...
      screenshotAttemptWarning:
        "Warning: Screenshot detected on your device. This has been logged as a security violation.",
      ...
      cameraPermissionRequired:
        "Camera permission is required to continue this exam.",
      cameraError: "Camera error: {error}",
      snapshotUploadRetry:
        "Snapshot upload failed. Retrying on the next cycle.",
      ...
      examWindowClosed:
        "The exam schedule window has closed and your attempt has ended.",
    ...
    grading: {
      ...
      autoLabel: "auto",
      failedToLoad: "Failed to load submission",
      failedToSaveGrade: "Failed to save grade",
      failedToFinalize: "Failed to finalize grading",
    },
    ...
    proctor: {
      ...
      realTimeActivity: "Real-time activity from candidate's exam session",
      ...
      liveStreamEnded: "The live video stream has ended",
      streamEnded: "Stream ended",
      waitingForVideo: "Waiting for candidate video…",
      noSnapshotsCapt: "No snapshots captured",
      waitingForScreen: "Waiting for screen share…",
      noScreenShare: "No screen share",
      webcamLabel: "Webcam",
      screenLabel: "Screen",
      ...
      proctorDecision: "Proctor Decision",
      statusLabel: "Status",
      ...
      ip: "IP",
      device: "Device",
      autoTerminationAt: "Auto-termination at {count} countable violations",
      noAutoTermination: "No auto-termination threshold set",
      countableViolations: "Countable Violations",
      totalViolations: "Total Violations",
      thresholdUsage: "Threshold Usage",
      ...
      noSecurityReq: "No security requirements",
      ...
      passed: "✓ Passed",
      failed: "✗ Failed",
      extraTimeAdded: "Extra Time Added",
      submittedAt: "Submitted At",
      ...
      noIncidentsCreated: "No incidents created",
      manuallyCreatedIncidents: "Manually created incident cases",
      addTimeTitle: "Add Time to Exam",
      addTimeDesc:
        "Extend exam time for {name}. The candidate will be notified instantly.",
      ...
      reasonPlaceholder: "e.g. Technical issue, accommodation request...",
      adding: "Adding...",
      addMinutes: "Add {count} Minutes",
      ...
      screenConnecting: "Screen…",
      screenReconnecting: "Screen Reconnecting…",
      screenOff: "Screen Off",
      // Session detail toasts
      failedToLoadSession: "Failed to load session",
      redirectingToReport:
        "Redirecting to session report in {seconds} seconds…",
      viewReportNow: "View Report Now",
      candidateSubmittedExam:
        "Candidate has submitted the exam (Attempt #{id})",
      examTerminatedReason: "Exam terminated: {reason}",
      violationLabel: "Violation: {type}",
      severityLabel: "Severity: {severity}",
      examExpiredAttempt: "Exam has expired (Attempt #{id})",
      failedToReviewIncident: "Failed to review incident",
      failedToUpdateFlag: "Failed to update flag",
      sessionMayNotBeActive:
        "The session may no longer be active. Please refresh the page.",
      failedToAddTime: "Failed to add time",
      minutesAddedSuccess: "{count} minutes added successfully",
      incidentCreatedNum: "Incident {num} created",
      failedToCreateIncident: "Failed to create incident",
      aiAnalysisGenerated: "AI analysis generated successfully",
      failedToGenerateAi: "Failed to generate AI analysis",
      // Severity labels
      ...
      severityInfo: "Info",
      // Event type names
      eventTabSwitched: "TabSwitched",
      eventFaceNotDetected: "FaceNotDetected",
      eventFullscreenExited: "FullscreenExited",
      eventCameraBlocked: "CameraBlocked",
      eventMultipleFaces: "MultipleFaces",
      eventHeadTurned: "HeadTurned",
      eventFaceOutOfFrame: "FaceOutOfFrame",
      eventCopyAttempt: "CopyAttempt",
      eventPasteAttempt: "PasteAttempt",
      eventWindowBlur: "WindowBlur",
      eventRightClick: "RightClick",
      eventWebcamDenied: "WebcamDenied",
      ...
      examLabel: "Exam",
      examIdLabel: "Exam ID",
      violationsAtCreate: "Violations at Create",
      tabTimeline: "Timeline",
      tabEvidence: "Evidence",
      tabDecisions: "Decisions",
      tabComments: "Comments",
      noTimelineEvents: "No timeline events yet",
      noEvidenceLinked: "No evidence linked yet",
      noDecisionsRecorded: "No decisions recorded yet",
      noCommentsYet: "No comments yet",
      viewEvidence: "View",
      linkedAt: "Linked {date}",
      decidedByLabel: "Decided by: {name}",
      riskAtDecision: "Risk score at decision: {score}",
      addCommentPlaceholder: "Add a comment...",
      editedLabel: "(edited)",
      pendingOutcome: "Pending",
      viewSession: "View Session",
      recordDecisionTitle: "Record Decision",
      recordDecisionDesc: "Record a formal decision on case {caseNumber}",
      ...
      reasonOptionalField: "Reason (optional)",
      whyChangingStatus: "Why are you changing the status?",
      updateStatus: "Update Status",
      reopenCaseTitle: "Reopen Case",
      reopenCaseDesc: "Provide a reason for reopening case {caseNumber}",
      reasonRequired: "Reason *",
      whyReopening: "Why are you reopening this case?",
      outcomeCleared: "Cleared — No wrongdoing found",
      outcomeSuspicious: "Suspicious — Flagged for monitoring",
      outcomeInvalidated: "Invalidated — Exam result voided",
      outcomeEscalated: "Escalated — Referred to higher authority",
      failedToLoadCase: "Failed to load incident case",
      decisionRecorded: "Decision recorded",
      failedToRecordDecision: "Failed to record decision",
      caseClosed: "Case closed",
      failedToCloseCase: "Failed to close case",
      caseReopened: "Case reopened",
      failedToReopenCase: "Failed to reopen case",
      statusUpdated: "Status updated",
      failedToChangeStatus: "Failed to change status",
      commentAdded: "Comment added",
      failedToAddComment: "Failed to add comment",
      byActorLabel: "by {name}",
    },

    // Identity Verification
    identityVerification: {
      title: "User Identification",
      subtitle: "Review and manage candidate identity verifications",
      ...
      noVerificationsDesc:
        "There are no identity verification requests matching your criteria.",
      detailTitle: "Identity Verification Details",
      ...
      actionSuccess: "Action applied successfully",
      bulkSuccess: "Bulk action completed",
      bulkPartial: "Bulk action partially completed",
  ...
  ar: {
    ...
    nav: {
      ...
      terminatedAttempts: "المحاولات المُنهاة",
      certificate: "الشهادة",
    ...
    instructions: {
      ...
      screenSharingDesc: "سيُطلب منك مشاركة شاشتك أثناء الاختبار",
      screenMonitoring: "مراقبة الشاشة",
      testScreenShare: "اختبار",
      required: "مطلوب",
    ...
    grading: {
      ...
      autoLabel: "تلقائي",
      failedToLoad: "فشل تحميل التسليم",
      failedToSaveGrade: "فشل حفظ الدرجة",
      failedToFinalize: "فشل إتمام التصحيح",
    },
    ...
    proctor: {
      ...
      violationsOnly: "المخالفات فقط",
      allEvents: "جميع الأحداث",
      realTimeActivity: "نشاط الوقت الفعلي من جلسة اختبار المرشح",
      noViolationsDetected: "لم يتم اكتشاف مخالفات",
      noEventsRecorded: "لم يتم تسجيل أحداث بعد",
      examSubmitted: "تم تقديم الاختبار",
      examExpired: "انتهت صلاحية الاختبار",
      sessionTerminatedTitle: "تم إنهاء الجلسة",
      liveStreamEnded: "انتهى البث المباشر للفيديو",
      streamEnded: "انتهى البث",
      waitingForVideo: "بانتظار فيديو المرشح…",
      noSnapshotsCapt: "لم يتم التقاط لقطات",
      waitingForScreen: "بانتظار مشاركة الشاشة…",
      noScreenShare: "لا يوجد مشاركة شاشة",
      ...
      missedHeartbeats: "نبضات القلب الفائتة",
      proctorDecision: "قرار المراقب",
      statusLabel: "الحالة",
      decidedBy: "قرار بواسطة",
      decidedAt: "تاريخ القرار",
      overridden: "تم التجاوز",
      deviceBrowser: "الجهاز والمتصفح",
      browser: "المتصفح",
      os: "نظام التشغيل",
      screenRes: "الشاشة",
      ip: "عنوان IP",
      device: "الجهاز",
      autoTerminationAt: "إنهاء تلقائي عند {count} مخالفة محسوبة",
      noAutoTermination: "لم يتم تحديد حد للإنهاء التلقائي",
      countableViolations: "المخالفات المحسوبة",
      totalViolations: "إجمالي المخالفات",
      thresholdUsage: "استخدام الحد",
      ...
      noCopyPaste: "منع النسخ/اللصق",
      browserLock: "قفل المتصفح",
      screenMonitor: "مراقبة الشاشة",
      noSecurityReq: "لا توجد متطلبات أمان",
      attemptProgress: "تقدم المحاولة",
      questionsAnswered: "الأسئلة المجابة",
      completion: "الإكمال",
      scoreLabel: "الدرجة",
      passed: "✓ ناجح",
      failed: "✗ غير ناجح",
      extraTimeAdded: "الوقت الإضافي المضاف",
      submittedAt: "تم التقديم في",
      identityVerificationTitle: "التحقق من الهوية",
      faceMatchScore: "درجة تطابق الوجه",
      liveness: "الحيوية",
      documentType: "نوع المستند",
      documentUploaded: "تم رفع المستند",
      yesLabel: "✓ نعم",
      noLabel: "✗ لا",
      verificationRisk: "مخاطر التحقق",
      submitted: "تم التقديم",
      aiProctorReport: "تقرير المراقب بالذكاء الاصطناعي",
      aiPoweredAdvisory: "تحليل مخاطر بالذكاء الاصطناعي — استشاري فقط",
      generateAiAnalysis: "إنشاء تحليل بالذكاء الاصطناعي",
      generateAiDesc:
        "إنشاء تحليل بالذكاء الاصطناعي لأنماط المخاطر والسلوك في هذه الجلسة",
      analyzingSession: "جارٍ تحليل الجلسة بالذكاء الاصطناعي...",
      riskExplanation: "شرح المخاطر",
      sessionOverview: "نظرة عامة على الجلسة",
      violationAnalysis: "تحليل المخالفات",
      behaviorAnalysis: "تحليل السلوك",
      environmentAssessment: "تقييم البيئة",
      suspiciousBehaviors: "سلوكيات مشبوهة",
      aggravatingFactors: "عوامل مشددة",
      mitigatingFactors: "عوامل مخففة",
      recommendation: "التوصية",
      integrityVerdict: "حكم النزاهة",
      riskTimeline: "الجدول الزمني للمخاطر",
      detailedAnalysis: "التحليل المفصل",
      regenerate: "إعادة الإنشاء",
      noIncidentsCreated: "لم يتم إنشاء حوادث",
      manuallyCreatedIncidents: "الحوادث المنشأة يدوياً",
      addTimeTitle: "إضافة وقت للاختبار",
      addTimeDesc: "تمديد وقت الاختبار لـ {name}. سيتم إشعار المرشح فوراً.",
      minutesToAdd: "الدقائق المضافة",
      fiveMin: "5 دقائق",
      tenMin: "10 دقائق",
      fifteenMin: "15 دقيقة",
      thirtyMin: "30 دقيقة",
      reasonOptional: "السبب (اختياري)",
      reasonPlaceholder: "مثال: مشكلة تقنية، طلب تسهيلات...",
      adding: "جارٍ الإضافة...",
      addMinutes: "إضافة {count} دقيقة",
      screenshotPreview: "معاينة اللقطة",
      snapshotsLabel: "لقطات",
      latestSnapshot: "أحدث لقطة",
      connecting: "جارٍ الاتصال…",
      reconnecting: "إعادة الاتصال…",
      offline: "غير متصل",
      screenLive: "الشاشة مباشرة",
      screenConnecting: "الشاشة…",
      screenReconnecting: "إعادة اتصال الشاشة…",
      screenOff: "الشاشة متوقفة",
      // Session detail toasts
      failedToLoadSession: "فشل تحميل الجلسة",
      redirectingToReport:
        "إعادة التوجيه إلى تقرير الجلسة خلال {seconds} ثوانٍ…",
      viewReportNow: "عرض التقرير الآن",
      candidateSubmittedExam: "قدّم المرشح الاختبار (المحاولة #{id})",
      examTerminatedReason: "تم إنهاء الاختبار: {reason}",
      violationLabel: "مخالفة: {type}",
      severityLabel: "الخطورة: {severity}",
      examExpiredAttempt: "انتهت صلاحية الاختبار (المحاولة #{id})",
      failedToReviewIncident: "فشل مراجعة الحادثة",
      failedToUpdateFlag: "فشل تحديث التعليم",
      sessionMayNotBeActive: "قد لا تكون الجلسة نشطة. يرجى تحديث الصفحة.",
      failedToAddTime: "فشل إضافة الوقت",
      minutesAddedSuccess: "تمت إضافة {count} دقيقة بنجاح",
      incidentCreatedNum: "تم إنشاء الحادثة {num}",
      failedToCreateIncident: "فشل إنشاء الحادثة",
      aiAnalysisGenerated: "تم إنشاء تحليل الذكاء الاصطناعي بنجاح",
      failedToGenerateAi: "فشل إنشاء تحليل الذكاء الاصطناعي",
      // Severity labels
      ...
      // Event type names
      eventTabSwitched: "تبديل التبويب",
      eventFaceNotDetected: "عدم اكتشاف الوجه",
      eventFullscreenExited: "خروج من ملء الشاشة",
      eventCameraBlocked: "حجب الكاميرا",
      eventMultipleFaces: "وجوه متعددة",
      eventHeadTurned: "تحويل الرأس",
      eventFaceOutOfFrame: "الوجه خارج الإطار",
      eventCopyAttempt: "محاولة نسخ",
      eventPasteAttempt: "محاولة لصق",
      eventWindowBlur: "فقدان تركيز النافذة",
      eventRightClick: "نقر يمين",
      eventWebcamDenied: "رفض الكاميرا",
      ...
      caseDetailsCard: "تفاصيل الحالة",
      candidateCard: "المرشح",
      examCard: "الاختبار",
      sourceLabel: "المصدر",
      ...
      resolvedByLabel: "حُلَّت بواسطة",
      resolvedAtLabel: "تاريخ الحل",
      nameLabel: "الاسم",
      emailLabel: "البريد الإلكتروني",
      attemptLabel: "المحاولة",
      sessionLabel: "الجلسة",
      examLabel: "الاختبار",
      examIdLabel: "معرّف الاختبار",
      violationsAtCreate: "المخالفات عند الإنشاء",
      tabTimeline: "الجدول الزمني",
      tabEvidence: "الأدلة",
      tabDecisions: "القرارات",
      tabComments: "التعليقات",
      noTimelineEvents: "لا توجد أحداث في الجدول الزمني بعد",
      noEvidenceLinked: "لم يتم ربط أي أدلة بعد",
      noDecisionsRecorded: "لم يتم تسجيل أي قرارات بعد",
      noCommentsYet: "لا توجد تعليقات بعد",
      viewEvidence: "عرض",
      linkedAt: "تم الربط {date}",
      decidedByLabel: "قرار بواسطة: {name}",
      riskAtDecision: "درجة المخاطرة عند القرار: {score}",
      addCommentPlaceholder: "أضف تعليقاً...",
      editedLabel: "(تم التعديل)",
      pendingOutcome: "قيد الانتظار",
      viewSession: "عرض الجلسة",
      recordDecisionTitle: "تسجيل قرار",
      recordDecisionDesc: "تسجيل قرار رسمي على الحالة {caseNumber}",
      outcomeField: "النتيجة",
      reasonNotes: "السبب / الملاحظات",
      explainDecision: "اشرح قرارك...",
      closeCaseAfterDecision: "إغلاق الحالة أيضاً بعد تسجيل القرار",
      changeStatusTitle: "تغيير الحالة",
      changeStatusDesc: "تحديث حالة الحالة {caseNumber}",
      ...
      reasonOptionalField: "السبب (اختياري)",
      whyChangingStatus: "لماذا تغير الحالة؟",
      updateStatus: "تحديث الحالة",
      reopenCaseTitle: "إعادة فتح الحالة",
      reopenCaseDesc: "أدخل سبب إعادة فتح الحالة {caseNumber}",
      reasonRequired: "السبب *",
      whyReopening: "لماذا تعيد فتح هذه الحالة؟",
      outcomeCleared: "تم التبرئة — لم يُعثر على مخالفة",
      outcomeSuspicious: "مشبوه — مُعلَّم للمراقبة",
      outcomeInvalidated: "ملغى — تم إلغاء نتيجة الاختبار",
      outcomeEscalated: "مُصعَّد — أحيل إلى سلطة أعلى",
      failedToLoadCase: "فشل تحميل حالة الحادثة",
      decisionRecorded: "تم تسجيل القرار",
      failedToRecordDecision: "فشل تسجيل القرار",
      caseClosed: "تم إغلاق الحالة",
      failedToCloseCase: "فشل إغلاق الحالة",
      caseReopened: "تم إعادة فتح الحالة",
      failedToReopenCase: "فشل إعادة فتح الحالة",
      statusUpdated: "تم تحديث الحالة",
      failedToChangeStatus: "فشل تغيير الحالة",
      commentAdded: "تم إضافة التعليق",
      failedToAddComment: "فشل إضافة التعليق",
      byActorLabel: "بواسطة {name}",
    },
    ...
    identityVerification: {
      ...
      reject: "رفض",
      flag: "تعليم",
      bulkApprove: "قبول جماعي",
      bulkReject: "رفض جماعي",
      selected: "محدد",
      clearSelection: "مسح",
      noVerifications: "لا توجد عمليات تحقق",
      noVerificationsDesc: "لا توجد طلبات تحقق من الهوية تتطابق مع معاييرك.",
      detailTitle: "تفاصيل التحقق من الهوية",
      idDocument: "وثيقة الهوية",
      selfie: "صورة شخصية",
      faceMatchScore: "درجة مطابقة الوجه",
      livenessCheck: "فحص الحيوية",
      ...
      reason: "السبب",
      reasonPlaceholder: "أدخل السبب (اختياري)...",
      confirmAction: "تأكيد الإجراء",
      actionSuccess: "تم تطبيق الإجراء بنجاح",
      bulkSuccess: "تم إكمال الإجراء الجماعي",
      bulkPartial: "تم إكمال الإجراء الجماعي جزئياً",
      notChecked: "لم يُفحص",
      passed: "ناجح",
      failed: "فاشل",
      ...
      totalFlagged: "إجمالي المُعلَّم",
      totalApproved: "مقبول اليوم",
      totalRejected: "مرفوض اليوم",
    },
