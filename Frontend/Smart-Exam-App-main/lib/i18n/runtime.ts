...
const exactMessageMap: Record<string, string> = {
  ...
  "Session expired. Please login again.": "انتهت صلاحية جلستك. يرجى تسجيل الدخول مرة أخرى.",
  ...
  "Notification queued for retry.": "تمت إعادة جدولة الإشعار للمحاولة مرة أخرى.",
  ...
  "Proctor snapshots are not uploading":
    "لا يتم رفع لقطات المراقبة حالياً.",
  ...
  "Builder configuration saved successfully":
    "تم حفظ إعدادات البناء بنجاح.",
  ...
  "AI analysis generated successfully": "تم إنشاء تحليل الذكاء الاصطناعي بنجاح.",
...
function normalizeWhitespace(value: string): string {
  return value.replace(/\u2022|â€¢/g, "-").replace(/\r/g, "").replace(/[ \t]+\n/g, "\n").trim()
}
